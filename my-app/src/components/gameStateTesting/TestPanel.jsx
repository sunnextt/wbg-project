  ...
  return (
    <div className='fixed top-4 right-4 bg-gray-800 text-white p-4 rounded-lg z-50'>
      ...
      <div className='grid grid-cols-1 gap-1'>
        ...
        <button
          onClick={() => {
            // Force reset by toggling test mode
            gameManager.setTestMode(false)
            setTimeout(() => {
              gameManager.loadTestState('GREEN_READY_TO_ENTER_HOME')
            }, 100)
          }}
          className='w-full bg-orange-600 hover:bg-orange-700 p-2 rounded text-sm'
        >
          🔄 Force Reset Test
        </button>
      </div>

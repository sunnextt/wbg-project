...
const LudoBoard = forwardRef((props, ref) => {
  ...
  // Core function: try to move a pawn
  const attemptPawnMove = (pawnId) => {
    ...
    const validationResult = isValidMove(currentPawn.position, gameState.diceValue, playerColor, playerPawnIndex)
  ...
  }, [camera, gl, gameState, currentPlayerId, onPawnMove, players, socket, gameId])
